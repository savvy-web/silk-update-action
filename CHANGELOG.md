...
* [`66ebacd`](https://github.com/savvy-web/pnpm-config-dependency-action/commit/66ebacd92c126eb454b45f26a7d5dada28955933) ### Match dependencies across all writable sections
...
* [`66ebacd`](https://github.com/savvy-web/pnpm-config-dependency-action/commit/66ebacd92c126eb454b45f26a7d5dada28955933) Removed the local `Workspaces` service wrapper now that
