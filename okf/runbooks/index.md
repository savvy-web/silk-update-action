...
* [Regenerate the result output's JSON Schema after editing RunResultDocument](regenerate-the-result-schema.md) - Edit the domain type, regenerate through the generator script, and let the drift test confirm the committed schema still matches — never hand-edit the generated JSON.
